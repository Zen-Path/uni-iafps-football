...
import { DEFAULT_TEAMS_old } from "./teams.js";
...
function main() {
    const teams = getUniqueRandomElements(DEFAULT_TEAMS_old, 2);
    ...
    document.getElementById("teamForm").addEventListener("submit", function (event) {
        ...
        const teamData = {
            teamA: {
                playerCount: formData.get("teamA_player_count"),
                order: formData.get("teamA_order"),
            },
            teamB: {
                playerCount: formData.get("teamB_player_count"),
