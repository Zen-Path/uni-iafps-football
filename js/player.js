...
export const DEFAULT_PLAYERS = [
    ...
    new Player("Raphinha", "", "../assets/images/players/raphinha.png"),
    ...
    new Player("Rodri", "", "../assets/images/players/rodri.png"),
    ...
    new Player("Rodrygo", "", "../assets/images/players/rodrygo.png"),
    new Player(
        "Charles",
        "De,Ketelaere",
        "../assets/images/players/charles-de ketelaere.png",
    ),
    ...
    new Player("Virgil", "van,Dijk", "../assets/images/players/virgil-van dijk.png"),
    ...
    new Player("Stefan", "de,Vrij", "../assets/images/players/stefan-de vrij.png"),
