...
export const DEFAULT_TEAMS = [
    ...
    new Team("AFC Bournemouth", "afc-bournemouth.png"),
    new Team("Chelsea FC", "chelsea-fc.png"),
    new Team("Benfica", "benfica.png"),
    new Team("Lille", "lille.png"),
    new Team("Nottingham Forest", "nottingham-forest.png"),
    ...
    new Team("Crystal Palace", "crystal-palace.png"),
    ...
    new Team("RB Leipzig", "rb-leipzig.png"),
